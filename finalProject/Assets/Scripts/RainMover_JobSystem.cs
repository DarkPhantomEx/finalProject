...
public class RainMover_JobSystem : JobComponentSystem
{
    ...
    [BurstCompile]
    [RequireComponentTag(typeof(rain_tag))]
    struct RainMover_JobSystemJob : IJobForEach<Translation, rainSpeed_Component, rainParticle_Component>
    {
    ...
    {
        var job = new RainMover_JobSystemJob();
